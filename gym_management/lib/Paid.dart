...
//int amount = int.parse(monthly_Fees)+int.parse(trademil_fees)+int.parse(lights_Fees)+int.parse(personal_Fees) + int.parse(registraionFee) +int.parse(other_Fees);
 var request = await Services().submitUserFee(widget.user.registrationNo!, mode ,int.parse(registraionFee) , int.parse(monthly_Fees) ,int.parse(trademil_fees) , int.parse(lights_Fees) , int.parse(personal_Fees) , int.parse(other_Fees) , Note , joiningDate.toString());
