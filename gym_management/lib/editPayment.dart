...
// else
  ...
  collectAllInfo() {
    setState(() {
      registration_Fees_Controller.text =
          widget.data["registrationfee"].toString();
      ...
      personal_Fees_Controller.text =
          widget.data["personalTraining"].toString();
      fees_note_Controller.text = widget.data["feeNote"];
      submitDate = DateTime.parse(widget.data["date"]);
      submitingDateShow =
          "${DateFormat("dd").format(submitDate!)}  ${DateFormat("MMMM").format(submitDate!)}  ${DateFormat("y").format(submitDate!)}";
  ...
  submitFee() async {
    ...
    String date = DateFormat("yyyy-MM-dd")
        .format(DateTime(submitDate!.year, submitDate!.month, submitDate!.day));
//int amount = int.parse(monthly_Fees)+int.parse(trademil_fees)+int.parse(lights_Fees)+int.parse(personal_Fees) + int.parse(registraionFee) +int.parse(other_Fees);
    var request = await Services().editUserFee(
