...
class EditPayment extends StatefulWidget {
  var data;
  EditPayment({super.key , required  this.data});
...
class _EditPaymentState extends State<EditPayment> {
  ...
  //  TextEditingController annual_Fees_Controller = TextEditingController();
   ...
   paymentMode mode = paymentMode.online; 
     String submitingDateShow = "00-00-0000";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(appBar: AppBar(title: Text("Pay Fee")),
...
//             children: [
        ...
        Container(width: unitwidth*100,height: unitheight*15,
        child: Column(children: [
                    SizedBox(height: unitwidth*4,),
         Row(children: [
          SizedBox(width: unitwidth*7,),
           Text("Registration Fee" ,style: GoogleFonts.montserrat(
                                          textStyle: TextStyle(
                                              color: Colors.white,
      ...
      Container(width: unitwidth*100,height: unitwidth*20, margin:EdgeInsets.symmetric(horizontal: unitwidth*7, vertical: unitwidth*2),child: TextFormField(
...
Container(width: unitwidth*100,height: unitheight*15,
        child: Column(children: [
         ...
         Row(children: [
          SizedBox(width: unitwidth*7,),
           Text("Monthly Fee" ,style: GoogleFonts.montserrat(
                                          textStyle: TextStyle(
                                              color: Colors.white,
                                              fontWeight: FontWeight.w600,
                                              fontSize: unitwidth *
...
return "Please enter Registration charges";
 ...
 Container(width: unitwidth*100,height: unitheight*15,
        child: Column(children: [
         ...
         Row(children: [
          SizedBox(width: unitwidth*7,),
           Text("Trademil Fee" ,style: GoogleFonts.montserrat(
                                          textStyle: TextStyle(
                                              color: Colors.white,
                                              fontWeight: FontWeight.w600,
                                              fontSize: unitwidth *
...
//if(widget.user.lightsChargesFee! != 0)
 Container(width: unitwidth*100,height: unitheight*15,
        child: Column(children: [
         ...
         Row(children: [
          SizedBox(width: unitwidth*7,),
           Text("Lights Charges" ,style: GoogleFonts.montserrat(
                                          textStyle: TextStyle(
                                              color: Colors.white,
                                              fontWeight: FontWeight.w600,
                                              fontSize: unitwidth *
...
Container(width: unitwidth*100,height: unitheight*15,
        child: Column(children: [
         ...
         Row(children: [
          SizedBox(width: unitwidth*7,),
           Text("Personal Training Fee" ,style: GoogleFonts.montserrat(
                                          textStyle: TextStyle(
                                              color: Colors.white,
                                              fontWeight: FontWeight.w600,
                                              fontSize: unitwidth *
...
return "Please enter Personal Training Fee";
  ...
  keyboardType: TextInputType.number,
        ...
        child: Column(children: [
         ...
         Row(children: [
          SizedBox(width: unitwidth*7,),
           Text("Other Fee" ,style: GoogleFonts.montserrat(
                                          textStyle: TextStyle(
                                              color: Colors.white,
                                              fontWeight: FontWeight.w600,
                                              fontSize: unitwidth *
...
return "Please enter Other  Fee";
  ...
  keyboardType: TextInputType.number,
        ...
        child: Column(children: [
         ...
         Row(children: [
          SizedBox(width: unitwidth*7,),
           Text("Fee Note" ,style: GoogleFonts.montserrat(
                                          textStyle: TextStyle(
                                              color: Colors.white,
                                              fontWeight: FontWeight.w600,
                                              fontSize: unitwidth *
  ...
  ),controller: fees_note_Controller,validator: (value) {
    if(value == null|| value.isEmpty){
return "";
    }else{
      return "";
...
if(submitingDateShow == "00-00-0000")
Text("Please pick a date" , style: GoogleFonts.montserrat(
      textStyle: TextStyle(
       color: Colors.red,
        ...
        Container(color: Colors.grey[900],alignment: Alignment.center,
                            height: unitheight * 9,
                            child:Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                              children: [
                                ...
                                MaterialButton(onPressed: (){
                                  ...
                                  child: Container(width: unitwidth*80,height: unitwidth*13,decoration: BoxDecoration(
                                    color: Colors.green, borderRadius: BorderRadius.all(Radius.circular(unitwidth*2))
                                    
                                  ),alignment: Alignment.center,
                                  child: Text("Pay" , style:  GoogleFonts.montserrat(
                                              textStyle: TextStyle(
                                                  color: Colors.white,fontWeight: FontWeight.w600,
                                                  fontSize: unitwidth *
                                                      1 *
  ...
  setState(() {
  registration_Fees_Controller.text = widget.data["registrationfee"].toString();
  other_Fees_Controller.text = widget.data["otherFee"].toString();
  monthly_Fees_Controller.text = widget.data["monthlyFee"].toString();
  trademil_Fees_Controller.text = widget.data["trademilFee"].toString();
  lights_Fees_Controller.text = widget.data["lightCharges"].toString();
  personal_Fees_Controller.text = widget.data["personalTraining"].toString();
  fees_note_Controller.text = widget.data["feeNote"];
   submitDate = DateTime.parse(widget.data["date"]);
     submitingDateShow = "${DateFormat("dd").format(submitDate!)}  ${DateFormat("MMMM").format(submitDate!)}  ${DateFormat("y").format(submitDate!)}";

     if(widget.data["paymentMode"].toString() == "online"){
...
personal_Fees = "0";
   ...
   String date = DateFormat("yyyy-MM-dd").format(DateTime(submitDate!.year , submitDate!.month , submitDate!.day));
//int amount = int.parse(monthly_Fees)+int.parse(trademil_fees)+int.parse(lights_Fees)+int.parse(personal_Fees) + int.parse(registraionFee) +int.parse(other_Fees);
 var request = await Services().editUserFee(int.parse(widget.data["id"].toString()), mode ,int.parse(registraionFee) , int.parse(monthly_Fees) ,int.parse(trademil_fees) , int.parse(lights_Fees) , int.parse(personal_Fees) , int.parse(other_Fees) , Note , date);
